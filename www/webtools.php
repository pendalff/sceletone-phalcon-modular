 ...
 * @var string
 */
define('PTOOLS_IP', '192.168.,127.0.0.');
 ...
 * @var string
 */
define('PTOOLSPATH', __DIR__. DIRECTORY_SEPARATOR. '..'. DIRECTORY_SEPARATOR. 'vendor'. DIRECTORY_SEPARATOR . 'phalcon' . DIRECTORY_SEPARATOR . 'devtools');
